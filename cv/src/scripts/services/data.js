...
* Private (Orlando, USA): Design and architecture definition for integrated inventory control mechanisms for Amazon listings`
      ...
      },
      {
        ...
        level: 'management',
        description: {
          company: `Discovery Health is South Africa’s largest medical insurance company with a history of innovative and disruptive products.`,
          tasks: `* Representing Health Systems on the Health Claims Operations EXCO
...
* Working with General Manager responsible for Business Architecture to define the overall Business Architecture strategy for Discovery Health`
      ...
      },
      {
        ...
        level: 'management',
        description: {
          company: `HealthBridge is an innovative transaction switch with a focus on the medical industry. Since it inception in 1999, the company has expanded into the TradeBridge group covering markets such as debt consolidation and mobile payments.`,
          tasks: `* Day-to-day management and mentoring of the development team
...
* Feedback on projects and software initiatives to HealthBridge MANCO`
      ...
      },
      {
        ...
        level: 'staff',
        description: {
          company: `Internet Solution is a leading ISP in ZA. In addition to the traditional ISP business, they also did project-based work for clients with Internet deployments and website development.`,
          tasks: `* Team Lead for the Dimension Data Healthcare project
...
* Dimension Data Healthcare led to the formation of HealthBridge`
      ...
      },
      {
        ...
        level: 'staff',
        description: {
          company: `Crusader System is an Artificial Intelligence consulting company with a large focus on process optimization in the mining industry.`,
          tasks: `* Development of the first-generation AI modeling tool, ModelGen
* Consulting to Richard’s Bay Mineral and Karee Platinum mines on process optimization using the ModelGen toolset`
      ...
      },
      {
        ...
        level: 'staff',
        description: {
          company: `Grinaker Electronics is a project-based company in the commercial sector (vehicle tracking) along with the implementation of projects for defense agencies such as ARMSCOR.`,
          tasks: `* Development and maintenance of the G-Track vehicle tracking system
