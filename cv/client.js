...
Reflect.defineMetadata('design:paramtypes', [Location, CVData], CV);
...
Reflect.defineMetadata('design:paramtypes', [Location, CVData], Menu);
var Position = (_dec7 = Component({
  ...
  function Position(location, data) {
...
Attribute('data')(Position, null, 1);
Reflect.defineMetadata('design:paramtypes', [Location,,], Position);

var CVData = (function () {
  _createClass(CVData, [{
    key: '_add',
    value: function _add(position) {
      var _pad = function _pad(num) {
        return ('0' + num).slice(-2);
      };

      var end = position.end ? '' + position.end.year + _pad(position.end.month) : 'current';
