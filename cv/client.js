...
angular.module('cv', ['ngSanitize']).config(["$locationProvider", function ($locationProvider) {
...
angular.module('cv').directive('cv', function () {
  return {
    restrict: 'E',
...
angular.module('cv').directive('markdown', function () {
  return {
    restrict: 'E',
...
angular.module('cv').directive('menu', function () {
  return {
    restrict: 'E',
  ...
  $scope.menu = [{ url: '/summary', title: 'Summary' }, { url: '/print', title: 'Print' }];
...
angular.module('cv').directive('position', function () {
  return {
    restrict: 'E',
...
angular.module('cv').service('CVData', function () {
